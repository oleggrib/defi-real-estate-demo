    ...
    <footer className="bg-secondary-900 text-white">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Valor Nuvesta</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-secondary-300 text-sm">
                ...
                <span>contact@valorinvest.com</span>
              </li>
              <li className="flex items-center text-secondary-300 text-sm">
        ...
        <div className="border-t border-secondary-700 mt-8 pt-8 text-center text-secondary-300 text-sm">
          <p>&copy; {new Date().getFullYear()} Valor Nuvesta. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

  ...
  const investmentSteps = [
    {
      ...
      description: 'Connect your cryptocurrency wallet to Valor Nuvesta to start investing.'
    },
    {
      icon: FaStore,
  ...
  const faqSections = [
    {
      ...
      questions: [
        {
          question: "What is Valor Nuvesta?",
          answer: "Valor Nuvesta is an innovative investment project dedicated to real estate. We allow clients to invest as little as $10 in investment properties, with the aim of building up regular income and/or savings."
        },
        {
        ...
        },
        {
          ...
          answer: "The Valor Nuvesta Marketplace is our platform that allows Valor Nuvesta community members to buy and sell NFTs among themselves.  It is the equivalent of a secondary market where investors can buy and sell NFTs among themselves. We may also cooperate with other marketplaces to allow anyone to choose their preferred marketplace."
        },
        {
        ...
        },
        {
          ...
          answer: "Valor Nuvesta uses the most advanced technical means to ensure the confidentiality and security of transactions on the platform. "
        }
      ]
    }
  ];
    ...
    <div className="space-y-16">
      ...
      <section className="bg-gradient-to-br from-sapphire-900 via-sapphire-800 to-sapphire-900 text-white py-16 relative overflow-hidden">
        ...
        <div className="container relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">How Valor Nuvesta Works</h2>
      ...
      <section className="bg-gradient-to-br from-sapphire-50 to-platinum-100 pt-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-sapphire-800">Why Choose Valor Nuvesta</h2>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full">
                ...
                <a
                  href="https://discord.gg/Valor Nuvesta"
                  target="_blank"
                ...
                <p className="mt-4 text-sm text-gray-500 text-center">
                  Already a member?{' '}
                  <a href="https://discord.gg/Valor Nuvesta" className="text-indigo-600 hover:text-indigo-500">
                    Sign in
                  </a>
                </p>
              </div>
